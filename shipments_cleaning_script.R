...
# Import Data
df <- read.csv("Data/shipments.csv")

# Change to Standard Column Names
colnames(df) <- c("year", "month", "plant_ID", "customer_ID", "market_code", "material_type_ID", "shipped_tons")
...
df %>%
  ...
  write.csv("Cleaned_Data/clean_shipments.csv")