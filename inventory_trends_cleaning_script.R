...
# Import Data
df <- read.csv("Data/inventory_trends.csv")

# Change to Standard Column Names
colnames(df) <- c("year", "month", "plant_ID", "customer_ID", "market_code", "material_type_ID", "available_tons")
...
df %>%
  ...
  write.csv("Cleaned_Data/clean_inventory_trends.csv")